...
const scenes = Actions.create(
  <Scene key="root" hideNavBar={true}>
    <Scene key="main" title="Home" component={MainView} initial={true} />
    <Scene key="settings" direction="vertical" title="Watch Stocks" component={SettingsView} />
    <Scene key="add" direction="vertical" title="Add Stock" component={AddView} />
  </Scene>
);
